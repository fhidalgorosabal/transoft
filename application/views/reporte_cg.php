	...
	<div class="row-fluid">	
		...
		<div class="row-striped">                     
                    <div class="table-toolbar"> 
                        ...
                        <div class="btn-group">
                            <form method="post" id="form_1" action="<?php echo base_url() ?>recorrido/reporte_carga_transportada_acumulado" class="form-search">
                        ...
                        <div class="pull-right" style="padding-top: 4px;"> 
                            ...
                            <a class="btn" href="<?php echo base_url() ?>recorrido/exportar_reporte_carga_transportada<?php if(isset($acumulado) && $acumulado){ echo '/'.$fecha['mes'].'/'.$fecha['anno']; } ?>">
