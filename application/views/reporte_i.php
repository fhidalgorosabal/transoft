...
<title><?php if(isset($titulo)): echo $titulo; endif;?></title>
  ...
  <script src="<?php echo base_url()?>assets/DT_bootstrap.js" type="text/javascript"></script>
</head>
<body class="reporte">
	...
	<div class="row-fluid">	
		...
		<div class="row-striped"> 
                    <div class="table-toolbar"> 
                        ...
                        <div class="btn-group">
                            <form method="post" id="form_1" action="<?php echo base_url() ?>principal/reporte_indicadores_acumulado" class="form-search">
                        ...
                        <div class="pull-right" style="padding-top: 4px;"> 
                            ...
                            <a class="btn" href="<?php echo base_url() ?>principal/exportar_reporte<?php if(isset($acumulado) && $acumulado){ echo '_acumulado/'.$fecha['mes'].'/'.$fecha['anno']; } ?>">
