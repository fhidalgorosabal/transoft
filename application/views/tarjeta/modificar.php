<div class="span12">
	...
	<h2 class="module-title box-header">Modificar Tarjeta</h2>
            <div class="row-striped">
                ...
                <?php if (isset($mensaje) && $mensaje==true): ?>           
                    <div class="alert alert-success alert-block">
                        ...
                        <p>
                            <i class="icon-checkmark"></i>&nbsp; ¡ La tarjeta se ha modificado correctamente !, <a href="<?php echo base_url() ?>tarjeta">desea regresar al listado</a>.
                        </p>    
                    </div>  
                ...
                <div class="span2"></div>
                    <div class="span8">
                        <form method="post" action="<?php echo base_url() ?>tarjeta/modificar_post/<?php echo $id_tarjeta ?>" name="modificar_licencia" id="modificar_licencia" class="form-horizontal">
                            <fieldset>
                                <div class="control-group">
                                    <label class="control-label">C&oacute;digo:</label>
                                    <div class="controls">
                                        <input name="codigo_tarjeta" type="text" class="span12" maxlength="4" value="<?php echo $codigo_tarjeta ?>"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input name="credito" type="text" class="span12" value="<?php echo $credito ?>"/>
                                    </div>
                                </div> 
