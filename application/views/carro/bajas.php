<div class="span12">
	...
	<h2 class="module-title box-header">Listado de los carros de baja</h2>
            <div class="row-striped">
                <div class="table-toolbar">
                    ...
                    <div class="pull-right">                        
                        <a class="btn" <?php if(count($listado)>0): ?>href="<?php echo base_url() ?>carro/exportar_bajas"<?php else:?>href="#"<?php endif;?>>
                ...
                <?php if (isset($delete) && !empty($delete)): ?>           
                    <div class="alert alert-success alert-block">
                        <a class="close" data-dismiss="alert" href="<?php echo base_url() ?>carro/baja">&times;</a>
                        <p>
                ...
                <?php elseif(isset($error) && !empty($error)):?>
                    <div class="alert alert-error alert-block">
                        ...
                        <p>
                            Los datos de este carro est&aacute;n siendo usados, si se elimina afectaría información registrada en la BD.
                        </p>
                    </div>
                <?php endif;?>                                    
                ...
                <?php foreach($listado as $carro): ?>
                    <tr>
                        ...
                        <td class="btn-group span1">                                
                            <a class="btn btn-success btn-right tooltip-bottom" href="<?php echo base_url() ?>carro/restaurar/<?php echo $carro->id_carro ?>" data-original-title="Restaurar">
                                <i class="icon-undo"></i> 
                            </a>
                            <a class="btn btn-danger btn-left eliminar_carro tooltip-bottom" href="<?php echo base_url() ?>carro/eliminar_baja/<?php echo $carro->id_carro ?>" data-original-title="Eliminar">
