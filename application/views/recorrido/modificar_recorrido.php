<div class="span12">
	...
	<div class="well well-small">
            ...
            <div class="block-content"> 
                <?php if (isset($mensaje) && $mensaje==true): ?>           
                    <div class="alert alert-success alert-block">
                        ...
                        <p>
                            <i class="icon-checkmark"></i>&nbsp; ¡ Los datos se modificaron correctamente !,  
                            <a href="<?php echo base_url() ?>recorrido/listar/<?php echo $actividad->id_actividad.'/'.$id_carro?>">
                                 desea ir al listado
                            </a>.
                        </p>    
                    </div>  
        ...
        <div class="block-content collapse in">
            <div class="span12">
                <form method="post" action="<?php echo base_url() ?>recorrido/modificar_post/<?php echo $id_recorrido.'/'.$actividad->id_actividad ?>" name="modificar_recorrido" id="modificar_recorrido" class="form-horizontal">
            <fieldset> 
            <div class="span12">    
...
<script>
    ...
    function nueva_fila(){  
       ...
       if(cont!=0){
            ...
            boton.setAttribute('title','Eliminar fila');
        }
    }
